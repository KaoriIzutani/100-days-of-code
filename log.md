...
**Today's Progress**: Went through some more basics on Python, such as making if, else and elif statements. 
...
**Today's Progress**: R2D33. Tried my hand with Codecademy's free Java course. The reason I took this is because some job assessments asked about Java questions and I wasn't familiar with Java.

**Thoughts**: Java looks a lot like the C# language, does it not?
...
**Today's Progress**: R3D3. Continued with the Modern React with Redux course. I got up to where I was tested on how to implement functions in React.
...
### Day 12: July 11th 2021, Saturday
